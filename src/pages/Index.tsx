  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barber Shop by Meti</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barber Shop by Meti in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber Shop by Meti | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barber Shop by Meti | Premium Barbershop Berlin" />
        <meta
